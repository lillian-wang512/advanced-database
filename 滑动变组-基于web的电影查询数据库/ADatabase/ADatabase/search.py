...
def missionOne(userId):
    ...
    for x in  movieId_remove_duplicate_value:
        ...
        # tag_relevance=[{'tag': 'comedy', 'relevance': 0.8}, {'tag': 'comedy', 'relevance': 0.8},
    ...
    item1 = [{'num': 1, 'timestamp': '20180101', 'title': 'Nurse Betty(2000)', 'rating': 3.5,
             'tags_relevance': [{'tag': 'Comedy', 'relevance': 0.8}, {'tag': 'Crime', 'relevance': 0.8},{'tag': 'Drama', 'relevance': 0.8}]},

             {'num': 2, 'timestamp': '20180101', 'title': 'Better Off Dead...(1985)', 'rating': 4.5,
             'tags_relevance': [{'tag': 'comedy', 'relevance': 0.8}, {'tag': 'Romance', 'relevance': 0.8},{'tag': 'Romance', 'relevance': 0.8}]},

             {'num': 3, 'timestamp': '20180101', 'title': 'Three Colors: Blue (Trois couleurs: Bleu)(1993)', 'rating': 3.5,
             'tags_relevance': [{'tag': 'Romance', 'relevance': 0.8}, {'tag': 'comedy', 'relevance': 0.8},{'tag': 'Action', 'relevance': 0.8}]},

             {'num': 4, 'timestamp': '20180101', 'title': 'Kalifornia(1993)', 'rating': 4.5,
             'tags_relevance': [{'tag': 'Drama', 'relevance': 0.8}, {'tag': 'Adventure', 'relevance': 0.8},{'tag': 'Crime', 'relevance': 0.8}]},

             {'num': 5, 'timestamp': '20180101', 'title': 'Do the Right Thing(1989)', 'rating': 4.5,
             'tags_relevance': [{'tag': 'Action', 'relevance': 0.8}, {'tag': 'comedy', 'relevance': 0.8},{'tag': 'comedy', 'relevance': 0.8}]},

             {'num': 6, 'timestamp': '20180101', 'title': 'Event Horizon(1997)', 'rating': 2.5,
             'tags_relevance': [{'tag': 'comedy', 'relevance': 0.8}, {'tag': 'Action', 'relevance': 0.8},{'tag': 'Adventure', 'relevance': 0.8}]},
             
             {'num': 7, 'timestamp': '20180101', 'title': 'Spawn(1997)', 'rating': 1.5,
             'tags_relevance': [{'tag': 'Romance', 'relevance': 0.8}, {'tag': 'Crime', 'relevance': 0.8},{'tag': 'comedy', 'relevance': 0.8}]},

             {'num': 8, 'timestamp': '20180101', 'title': 'Stigmata(1999)', 'rating': 3.5,
             'tags_relevance': [{'tag': 'Thriller', 'relevance': 0.8}, {'tag': 'Romance', 'relevance': 0.8},{'tag': 'Crime', 'relevance': 0.8}]},

             {'num': 9, 'timestamp': '20180101', 'title': 'iThree Amigos!(1986)', 'rating': 2.0,
             'tags_relevance': [{'tag': 'Action', 'relevance': 0.8}, {'tag': 'Thriller', 'relevance': 0.8},{'tag': 'comedy', 'relevance': 0.8}]}]
